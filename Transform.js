...
const people1 = [{name: "Henry", age: 9}, {name: "John", age: 20}];
const people2 = [{name: "Anna", age: 31}, {name: "John", age: 32}, {name: "Hank", age: 60}];
const people3 = [{name: "Henry", age: 9}, {name: "John", age: 20}, {name: "Anna", age: 31}, {name: "John", age: 32}, {name: "Hank", age: 60}];



const array1 = groupAdultsByAgeRange(people3)
